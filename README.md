...
![Formula 1 Lap Time Prediction](Readmeimage.jpg)
...
**Coverage**: 2023–2025 Formula 1 seasons (2025 partial)

**Note**: The `cache/` folder (~several GB) is not included in this repository. It can be regenerated by running `Formula1_dataset.ipynb`.
...
Regenerate the cache from FastF1 (requires several hours):

```bash
jupyter notebook Formula1_dataset.ipynb
```
...
- Limited 2025 data (partial season)
